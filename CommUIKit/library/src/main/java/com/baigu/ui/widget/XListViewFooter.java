...
public class XListViewFooter extends LinearLayout {
    ...
    private void initView(Context context) {
        ...
        mHintTextView = (TextView) moreView.findViewById(R.id.xlistview_footer_hint_textview);
        ...
        mHintNormal = context.getResources().getString(R.string.xlistview_footer_hint_normal);
        mHintReady = context.getResources().getString(R.string.xlistview_footer_hint_ready);
        mHintLoading = context.getResources().getString(R.string.xlistview_footer_hint_loading);
    }
