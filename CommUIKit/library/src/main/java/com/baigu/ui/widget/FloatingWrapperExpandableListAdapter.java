...
public class FloatingWrapperExpandableListAdapter extends BaseExpandableListAdapter {
    ...
    public FloatingWrapperExpandableListAdapter(ExpandableListAdapter adapter) {
