package com.baigu.ui.multiphotopicker.view;
...
import com.baigu.ui.multiphotopicker.event.DeletePictureListEvent;
import com.baigu.ui.multiphotopicker.model.ImageItem;
import com.baigu.ui.multiphotopicker.util.ImageDisplayer;
import com.baigu.ui.multiphotopicker.util.IntentConstants;
...
public class ImageZoomActivity extends Activity {
    ...
    private void removeImgs() {
        mDataList.clear();
        EventBus.getDefault().post(new DeletePictureListEvent(-1));
    }

    private void removeImg(int location) {
        if (location >= 0 && location < mDataList.size() - 1) {
            mDataList.remove(location);
            EventBus.getDefault().post(new DeletePictureListEvent(location));
        }
    }
