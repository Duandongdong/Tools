...
import com.bestgood.commons.sample.ui.ptr.loadmore.ui.views.TitleAndValue;
        ...
        QueryJsonHandler queryJsonHandler = new QueryJsonHandler() {
            ...
            public void onQueryFinish(Query.RequestType requestType, JsonData cacheData, boolean outOfDate) {
                ...
                if (cacheData != null) {
                    ...
                    Toast.makeText(getActivity(), "No cache is avariable, set first.", Toast.LENGTH_LONG).show();
                }
            }
