...
package com.bestgood.commons.ui.widget.datepicker;
...
public class NumberPicker extends LinearLayout {
     ...
     *
     * @param minValue The min value inclusive. <strong>Note:</strong> The length of
     ...
     *
     * @param maxValue The max value inclusive. <strong>Note:</strong> The length of
     *                 the displayed values array set via
     *                 {@link #setDisplayedValues(String[])} must be equal to the
     *                 range of selectable numbers which is equal to
     *                 {@link #getMaxValue()} - {@link #getMinValue()} + 1.
