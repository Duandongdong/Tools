package com.baigu.persist.sample.acache;
...
import com.baigu.persist.ACache;
import com.baigu.persist.sample.R;
import com.baigu.persist.sample.acache.beans.UserBean;
...
public class SaveObjectActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_acache_save_object);
        // 初始化控件
        initView();
