 ...
 */
public class ACacheObjectLoader<D extends Object> extends AsyncTaskLoader<D> {
    ...
    public ACacheObjectLoader(Context context, ACache cache, String key) {
        super(context);
