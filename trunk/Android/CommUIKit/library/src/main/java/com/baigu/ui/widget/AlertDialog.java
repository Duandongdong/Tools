...
public class AlertDialog extends Dialog {
	...
	public AlertDialog(Activity activity, int theme) {
	...
	public AlertDialog setPositiveButton(CharSequence text,
	...
	public AlertDialog setNegativeButton(CharSequence text,
			OnClickListener listener) {
