package com.baigu.ui.multiphotopicker.adapter;
...
import com.baigu.ui.multiphotopicker.model.ImageItem;
import com.baigu.ui.multiphotopicker.util.CustomConstants;
import com.baigu.ui.multiphotopicker.util.ImageDisplayer;
import com.baigu.util.ScreenUtils;
import com.baigu.util.SizeUtils;
...
public class ImagePublishAdapter extends BaseAdapter {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		float screenWidth = ScreenUtils.getScreenWidthPixels(mContext)
				- SizeUtils.dip2px(mContext, 10);
		float width = screenWidth / 3;
		GridView.LayoutParams params = new GridView.LayoutParams((int) width,
				(int) width);
