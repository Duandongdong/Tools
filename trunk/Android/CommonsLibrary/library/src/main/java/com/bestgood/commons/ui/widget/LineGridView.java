...
public class LineGridView extends GridView {
    ...
    protected void dispatchDraw(Canvas canvas) {
        ...
        if (localView1 != null && localView1.getWidth() > 0) {
            ...
            localPaint2.setStrokeWidth(2);
            localPaint.setColor(Color.parseColor("#FFDCDCDC"));
            localPaint2.setColor(Color.parseColor("#FFDCDCDC"));
...
//                            localPaint);
//                    canvas.drawLine(
//                            lastView.getRight() + lastView.getWidth() * j + 1,
//                            lastView.getTop(),
//                            lastView.getRight() + lastView.getWidth() * j + 1,
//                            lastView.getBottom(),
//                            localPaint2);
